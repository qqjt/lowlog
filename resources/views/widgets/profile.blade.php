<div class="profile-sidebar text-center d-none d-md-block">
    ...
    <div class="profile-buttons">
        ...
        <a href="https://github.com/{{config('blog.blogger.github')}}" title="github/{{config('blog.blogger.github')}}"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-github"></i></button></a>
    </div>
    <!-- END SIDEBAR BUTTONS -->
    <!-- SIDEBAR MENU -->
